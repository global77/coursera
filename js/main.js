$(function () {
	...
	////////////////////////////////////////////////////
	$('.js-currency-search').mouseover( function () {
		if (allCurrencies.is(":hidden")) {
                              allCurrencies.show("slow");
                       } else {
                               allCurrencies.hide("slow");
                       }
	});


	$('#search-country').mouseover( function () {
		if (allCountries.is(":hidden")) {
                              allCountries.show("slow");
                       } else {
                               allCountries.hide("slow");
                       }
	});


	//************************************///
	$('.lang_label_open').click( function () {
		if ($('.lang_label').is(":hidden")) {
                              $('.lang_label').show("slow");
                       } else {
                               $('.lang_label').hide("slow");
                       }
	});


	$('.reasons_label_open').click( function () {
